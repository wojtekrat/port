  ...
  return (  
    <div className='w-[90%] md:w-[70%] m-auto flex flex-col'>
      ...
      <div className='flex flex-col md:flex-row mt-[20px] '>
        <motion.div className='text-[20px] mb-[10px] md:mb-[0px] font-bold p-[20px] md:w-[50%] bg-neutral-900 rounded-3xl z-5' animate={{
          y:[300, 0],
          }}
          transition={{
            duration: 1,
        ...
        <motion.div className='md:w-[50%]  bg-neutral-900 p-[20px] rounded-3xl sm:ml-[10px]' 
          animate={{
          x:[300, 0],
          }}
          transition={{
