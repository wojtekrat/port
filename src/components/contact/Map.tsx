...
const Map: FC = () => {
  ...
  if (!isLoaded) {
    return (
      <div className='w-[700px] h-[550px] flex justify-center items-center flex-col'>
  ...
  return (
    <motion.div className='mt-[10px] md:mt-[50px] sm:ml-[20px] pb-[50px] ' animate={{
      ...
      transition={{
        ...
        <GoogleMap options={mapOptions} mapContainerClassName='w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] lg:w-[700px] lg:h-[540px] rounded-xl'>
